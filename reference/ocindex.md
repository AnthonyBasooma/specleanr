...
- absolute:
  ...
  `logical`. To output absolute outliers for a species.
...
`vector` or `dataframe` of absolute outliers, best outlier detection
method or data frame of absolute outliers and their proportions
